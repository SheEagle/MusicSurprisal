...
- `variance`: AI higher in 2/3 pairs; mean d = 0.90.
- `sd`: AI higher in 2/3 pairs; mean d = 0.83.
- `cv`: AI higher in 0/3 pairs; mean d = -1.34.
- `peak_rate`: AI higher in 3/3 pairs; mean d = 2.71.
- `peak_mass`: AI higher in 3/3 pairs; mean d = 2.67.
- `mean_abs_diff`: AI higher in 2/3 pairs; mean d = 0.53.
- `smoothness`: AI higher in 1/3 pairs; mean d = -0.52.
- `lag1_autocorr`: AI higher in 2/3 pairs; mean d = -0.32.
- `lag4_autocorr`: AI higher in 1/3 pairs; mean d = 0.20.
- `max_autocorr_lag2_16`: AI higher in 2/3 pairs; mean d = 0.34.
- `surprisal_entropy`: AI higher in 1/3 pairs; mean d = -0.22.
...
### maestro_vs_music_transformer_sample20
- `variance`: d = -0.04, AI-human = -0.053
- `sd`: d = -0.39, AI-human = -0.106
- `cv`: d = -1.22, AI-human = -0.029
- `peak_rate`: d = 2.27, AI-human = 0.056
- `peak_mass`: d = 2.21, AI-human = 0.160
- `mean_abs_diff`: d = -1.60, AI-human = -0.308
- `smoothness`: d = 1.73, AI-human = 0.049
- `lag1_autocorr`: d = 0.29, AI-human = 0.030
- `lag4_autocorr`: d = -0.12, AI-human = -0.008
- `max_autocorr_lag2_16`: d = 1.00, AI-human = 0.064
- `surprisal_entropy`: d = -0.44, AI-human = -0.121
